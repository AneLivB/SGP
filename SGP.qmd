...
Analysis.data$R2 <- ifelse(Analysis.data$Treatment == "Internal control", 1, 0)
Analysis.data$R3 <- ifelse(Analysis.data$Treatment == "Re-used detection plate", 1, 0)
Analysis.data$R4 <- ifelse(Analysis.data$Treatment == "Re-used PCR plate", 1, 0)
# 
...
Density.match.plot <- ggplot(data = model_info) +
  ...
  geom_vline(xintercept = 0, col = "grey60", linetype="longdash")+
  guides(fill = F, scale = "none") + #remove the legend
