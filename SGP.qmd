...
# #model bernoulli
# set.seed(1995) 
# model <- brms::brm(Match ~ Treatment + Loci + Mix + (1|ID) + (1|Rack),
#              data = Analysis.data,
#              family = bernoulli,
#              cores = 8,
#              iter = 1000*r,
...
# 
# set.seed(2024) 
# model.r <- brms::brm(Match ~ Treatment + (1|ID) + (1|Rack) + (1|Loci) + (1|Mix),
#              data = Analysis.data,
#              family = bernoulli,
#              cores = 8,
#              iter = 1000*r,
...
Missingdataplot <- Missingdata %>% 
  ...
  ylim(0,1400) +
  ylab("Total cases of missing data") +
