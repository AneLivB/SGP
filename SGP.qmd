...
Mismatch_loci <- function(DF1, DF2) {
  ...
  Loci$ID <- substring(Loci$ID, 5, 12)
...
#Including nanodrop values in the model means that one individual: 
r = 100
...
set.seed(2024)
model.missing <- brms::brm(Missing ~ Treatment + Nanodrop + (1|ID) + (1|Rack) + (1|Loci) + (1|Mix),
             data = Analysis.data,
             family = bernoulli,
             cores = 8,
             iter = 1000*r,
