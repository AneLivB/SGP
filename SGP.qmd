...
# #Create binary treatment variables
Analysis.data.missing$R2 <- ifelse(Analysis.data.missing$Treatment == "Internal control", 0.5, -0.5)
Analysis.data.missing$R3 <- ifelse(Analysis.data.missing$Treatment == "Re-used detection plate", 0.5, -0.5)
Analysis.data.missing$R4 <- ifelse(Analysis.data.missing$Treatment == "Re-used PCR plate", 0.5, -0.5)
# #A Bernoulli trial is a random experiment that has only two possible outcomes: success or failure.
...
set.seed(2024)
model.missing <- brms::brm(Missing ~ -1 + R2 + R3 + R4 + (1|ID) + (1|Rack) + (1|Loci) + (1|Mix),
