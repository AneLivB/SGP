...
#| echo: FALSE
#here::here()
invisible(pacman::p_load(dplyr, tidyverse, here, stringi, png, knitr, rstatix))
```
...
Failed_samples <- as.data.frame(cbind(Count_NAs(R154_R1), Count_NAs(R154_R2), Count_NAs(R154_R3), Count_NAs(R154_R4), Count_NAs(R155_R1), Count_NAs(R155_R2), Count_NAs(R155_R3), Count_NAs(R156_R1), Count_NAs(R156_R2))) 
...
Mismatches <- bind_rows(
  ...
  Mismatch(R156_R1, R156_R2)) %>% arrange(factor(Treatment, levels = c("Internal control", "Re-used PCR", "Re-used detection plate")))
...
Contamination_cases <- bind_rows(Detect_contamination(R154_R1, R154_R3, R156_R1), Detect_contamination(R154_R1, R154_R4, R156_R1), Detect_contamination(R155_R1, R155_R3, R154_R1))
...
#It is probably a good idea to further explore this relationship with a pairwise comparision 
#or some other posthoc analysis
